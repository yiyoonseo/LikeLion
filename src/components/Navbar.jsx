...
const Navbar = () => {
    ...
    return(
        ...
        <nav className="ph:hidden dt:flex w-full h-[64px] flex-row fixed top-0 left-0 justify-between items-center shadow-lg">
            <div className="pl-[96px] cursor-pointer" onClick={()=>nav("/")}>
                ShopMall
            </div>
        ...
        <nav className="dt:hidden ph:flex w-full h-[64px] flex-row fixed top-0 left-0 justify-between items-center shadow-lg">
            <div className="pl-[16px] cursor-pointer" onClick={()=>nav("/")}>ShopMall</div>
            <button
        ...
        <div className={`dt:hidden ph:fixed top-[64px] w-full h-[96px] px-[16px] py-[8px] flex flex-col justify-between bg-[#FFF] transition-transform duration-100
        ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} z-40 shadow-lg`}>
            ...
            <div className="h-[40px] items-center">
                <Link className="text-lg text-[#374151] cursor-pointer">Shopping Cart</Link>
            </div>
        </div>
        </>
    )
